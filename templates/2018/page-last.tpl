<div class="item" id="item-last">
      ...
      <p>{$text['page_important_legend']}</p>
        ...
        <button class="btn btn-default btn-lg wide-button" type="submit" id="submit-top">{$text['page_important_skip']}
      ...
      <!-- /buttons -->
        ...
        <button class="btn btn-default btn-lg wide-button" type="submit" id="submit-bottom">{$text['page_important_results']}
          <i class="fa fa-arrow-right"></i>
        </button>
