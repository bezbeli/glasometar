        ...
        <div class="row justify-content-center align-items-center">
            <div class="col">
                <div class="col d-flex justify-content-center align-items-center flex-sm-row flex-column">
                    ...
                    <a class="px-4 py-3" href="http://cpu.org.ba" title="CPU" id="footer-cpu-logo"><img src="/2018/images/cpu_logo.png" alt="logo CPU" /></a>
                ...
                <div class="col d-flex justify-content-center align-items-center flex-sm-row flex-column">
                    ...
                    <a class="px-4 py-3" href="https://ccfd-terresolidaire.org/" title="CCFD-Terre Solidaire" id="footer-ccfd-terre-solidaire-logo"><img src="/2018/images/ccfd_terre_solidaire_logo.png" alt="logo CCFD-Terre Solidaire" /></a>
                </div>
