                ...
                Glasometar.ba je aplikacija koja omogućava potencijalnim biračima u BiH da testiraju svoje stavove i mišljenja o ključnim pitanjima u politici, te da ih uporede sa stavovima i mišljenjima 18 najrelevantijih partija/stranaka u BiH.
                   ...
                   <div style="padding-bottom:3em">
				     <?php		
                        ...
                        $rand=rand(0,5);
                        if ($rand == 0) {
                          echo '<a class="btn btn-lg btn-success" href="2014/research.php' . $_SERVER['QUERY_STRING'] . '" data-rel="dialog">Pokreni aplikaciju</a>';
                          $str = session_id() . "\t" . "ba2014research" . "\t" . date("Y-m-d H:i:s") . "\t" . $_SERVER['QUERY_STRING'] .  "\t" . $_SERVER['REMOTE_ADDR'] . "\n";
                        }
                        else {
                          echo '<a class="btn btn-lg btn-success" href="2014?' . $_SERVER['QUERY_STRING'] . '" data-ajax="false">Pokreni aplikaciju</a>';
                          $str = session_id() . "\t" . "ba2014" . "\t" . date("Y-m-d H:i:s") . "\t" . $_SERVER['QUERY_STRING'] .  "\t" . $_SERVER['REMOTE_ADDR'] . "\n";
                        }
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
					...
					<p class="lead black"><a href="http://glasometar.ba">Glasometar.ba</a></p>
